...
# ----------------------
$sender    = Get-TextInput "Sender" "Input sender email address:" "arglebargle@kptrdte.nuwc.navy.mil"
...
$MailServer=localhost
 ...
 "Send-MailMessage -From $sender -To $recipient -Subject $subject -Body $subject -Attachments $attachments -SmtpServer "$MailServer"
